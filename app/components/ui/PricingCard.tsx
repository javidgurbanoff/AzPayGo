        ...
        <div className="container flex space-x-2">
          <div className="no-scrollbar overflow-hidden">
            <div className="flex no-scrollbar justify-start space-x-6 items-center overflow-x-auto">
              <button className="font-semibold cursor-pointer whitespace-nowrap text-base text-gray-500 hover:text-gray-600 transition-colors duration-300">
                Monthly
              </button>
              <button className="font-semibold cursor-pointer whitespace-nowrap text-base hover:text-gray-600 transition-colors duration-300 text-[#0B1F3A]">
                Annually
              </button>
            </div>
          </div>
              ...
              <div className="h-full z-10 relative">
                <div className="flex flex-col flex-1 justify-between h-full space-y-5">
                  <div className="flex justify-between flex-col">
                    <div className="text-xl md:text-2xl font-bold text-[#0B1F3A] flex justify-between">
                      <span>Starter</span>
                    </div>
                    ...
                    <div className="">
                      <ul className="space-y-2 pt-8">
                        <li className="flex items-center font-medium space-x-2 text-[#0B1F3A]">
                          <svg
                            className="h-4 w-4"
                            viewBox="0 0 24 24"
                            fill="none"
