...
const BasicMenu = () => {
  return (
    <StyledWrapper>
      <div className="input">
        <Link href="/profile" className="value">
          <svg
            data-name="Layer 2"
        ...
        <Link href="/account" className="value">
        ...
        <Link href="/appearance" className="value">
        ...
        <Link href="/accessibility" className="value">
        ...
        <Link href="/notifications" className="value">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 25"
            fill="none"
