...
const lengthUnitsPattern = "(?:".concat(lengthUnits.split(",").join("|"), ")");
const lengthRegExp = new RegExp("^[+-]?[0-9]*.?[0-9]+(?:[eE][+-]?[0-9]+)?".concat(lengthUnitsPattern, "$"));
...
function useCallbackRef(callback) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useCallbackRef.useCallback": function() {
            for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                args[_key] = arguments[_key];
            }
        ...
        "useMediaQuery.useState": ()=>{
            return queries.map({
                "useMediaQuery.useState": (query2, index)=>{
                    if (!ssr) {
                        var _getWindow;
                        const { media, matches } = ((_getWindow = getWindow === null || getWindow === void 0 ? void 0 : getWindow()) !== null && _getWindow !== void 0 ? _getWindow : window).matchMedia(query2);
                        return {
                            media,
                            matches
                        };
...
function useBreakpoint() {
    ...
    const breakpoints = allBreakpoints.map((param)=>{
        let { min, name: breakpoint } = param;
        const item = {
            breakpoint,
        ...
        let { breakpoint } = param;
        var _options_breakpoints;
        return !!((_options_breakpoints = options.breakpoints) === null || _options_breakpoints === void 0 ? void 0 : _options_breakpoints.includes(breakpoint));
    });
    const fallback = breakpoints.map((param)=>{
        let { fallback: fallback2 } = param;
        return fallback2;
    });
    ...
    var _breakpoints_index_breakpoint;
    return (_breakpoints_index_breakpoint = (_breakpoints_index = breakpoints[index]) === null || _breakpoints_index === void 0 ? void 0 : _breakpoints_index.breakpoint) !== null && _breakpoints_index_breakpoint !== void 0 ? _breakpoints_index_breakpoint : options.fallback;
}
...
"[project]/node_modules/@chakra-ui/react/dist/esm/hooks/use-overlay.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function createOverlay(Component, options) {
    ...
    const update = (id, props)=>{
        ...
        map.set(id, {
            ...prevProps,
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chakra$2d$ui$2f$react$2f$dist$2f$esm$2f$utils$2f$omit$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["omit"])(props, [
                "open",
                "onOpenChange",
                "onExitComplete"
            ])
    ...
    const get = (id)=>{
        ...
        if (!overlay) {
            throw new Error("[chakra-ui] Overlay with id ".concat(id, " not found"));
        }
        return overlay;
    };
    const removeAll = ()=>{
    ...
    function Viewport() {
        const overlays = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncExternalStore"](subscribe, getSnapshot, getSnapshot);
        return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: overlays.map((props, index)=>// @ts-expect-error - TODO: fix this
...
var _globalThis;
;
const useSafeLayoutEffect = typeof ((_globalThis = globalThis) === null || _globalThis === void 0 ? void 0 : _globalThis.document) !== "undefined" ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"];
;
}),
...
__turbopack_context__.s({
    ...
    "codeBlockAnatomy": ()=>codeBlockAnatomy,
...
//# sourceMappingURL=node_modules_%40chakra-ui_react_dist_esm_c9c65163._.js.map