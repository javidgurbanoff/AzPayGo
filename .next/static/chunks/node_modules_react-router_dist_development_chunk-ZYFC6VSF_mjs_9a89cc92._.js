...
"[project]/node_modules/react-router/dist/development/chunk-ZYFC6VSF.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function createMemoryHistory() {
    ...
    function createMemoryLocation(to) {
        let state = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, key = arguments.length > 2 ? arguments[2] : void 0;
...
function createLocation(current, to) {
    let state = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, key = arguments.length > 3 ? arguments[3] : void 0;
    let location = {
...
function createBrowserURLImpl(to) {
    let isAbsolute = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
...
function convertRoutesToDataRoutes(routes, mapRouteProperties2) {
    let parentPath = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [], manifest = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, allowInPlaceMutations = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : false;
...
function flattenRoutes(routes) {
    let branches = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], parentsMeta = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [], parentPath = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "";
    ...
    routes.forEach((route, index)=>{
        var _route_path;
        if (route.path === "" || !((_route_path = route.path) === null || _route_path === void 0 ? void 0 : _route_path.includes("?"))) {
...
function matchRouteBranch(branch, pathname) {
    let allowPartial = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
...
function compilePath(path) {
    let caseSensitive = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, end = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
...
function prependBasename(param) {
    let { basename, pathname } = param;
...
function resolvePath(to) {
    let fromPathname = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "/";
...
function resolveTo(toArg, routePathnames, locationPathname) {
    let isPathRelative = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
    let to;
...
var redirect = function(url) {
    let init = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 302;
...
function createRouter(init) {
    ...
    function completeNavigation(location, newState) {
        let { flushSync } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
        var _location_state, _location_state1;
        let isActionReload = state.actionData != null && state.navigation.formMethod != null && isMutationMethod(state.navigation.formMethod) && state.navigation.state === "loading" && ((_location_state = location.state) === null || _location_state === void 0 ? void 0 : _location_state._isRedirect) !== true;
        let actionData;
        ...
        let preventScrollReset = pendingPreventScrollReset === true || state.navigation.formMethod != null && isMutationMethod(state.navigation.formMethod) && ((_location_state1 = location.state) === null || _location_state1 === void 0 ? void 0 : _location_state1._isRedirect) !== true;
        ...
        pendingRevalidationDfd === null || pendingRevalidationDfd === void 0 ? void 0 : pendingRevalidationDfd.resolve();
    ...
    async function navigate(to, opts) {
        ...
        let normalizedPath = normalizeTo(state.location, state.matches, basename, to, opts === null || opts === void 0 ? void 0 : opts.fromRouteId, opts === null || opts === void 0 ? void 0 : opts.relative);
    ...
    async function startNavigation(historyAction, location, opts) {
        ...
        let matches = (opts === null || opts === void 0 ? void 0 : opts.initialHydration) && state.matches && state.matches.length > 0 && !initialMatchesIsFOW ? // `matchRoutes()` has already been called if we're in here via `router.initialize()`
    ...
    async function handleAction(request, location, submission, matches, scopedContext, isFogOfWar, initialHydration) {
        let opts = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : {};
        interruptActiveLoads();
    ...
    async function fetch2(key, routeId, href, opts) {
        ...
        let flushSync = (opts && opts.flushSync) === true;
        let routesToUse = inFlightDataRoutes || dataRoutes;
        let normalizedPath = normalizeTo(state.location, state.matches, basename, href, routeId, opts === null || opts === void 0 ? void 0 : opts.relative);
    ...
    async function startRedirectNavigation(request, redirect2, isNavigation) {
        let { submission, fetcherSubmission, preventScrollReset, replace: replace2 } = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
    ...
    function patchRoutes(routeId, children) {
        let unstable_allowElementMutations = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
        let isNonHMR = inFlightDataRoutes == null;
        let routesToUse = inFlightDataRoutes || dataRoutes;
...
function createStaticHandler(routes, opts) {
    ...
    let mapRouteProperties2 = (opts === null || opts === void 0 ? void 0 : opts.mapRouteProperties) || defaultMapRouteProperties;
    let dataRoutes = convertRoutesToDataRoutes(routes, mapRouteProperties2, void 0, manifest);
    async function query(request) {
        let { requestContext, filterMatchesToLoad, skipLoaderErrorBubbling, skipRevalidation, dataStrategy, unstable_generateMiddlewareResponse: generateMiddlewareResponse } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            ...
            try {
                ...
                let response = await runServerMiddlewarePipeline({
                    ...
                    if (renderedStaticContext) {
                        ...
                        var _matches_find;
                        let boundaryRouteId = skipLoaderErrorBubbling ? routeId : findNearestBoundary(matches, ((_matches_find = matches.find((m)=>m.route.id === routeId || m.route.loader)) === null || _matches_find === void 0 ? void 0 : _matches_find.route.id) || routeId).route.id;
                        let staticContext = {
                            matches,
                            location,
                            basename,
    ...
    async function queryRoute(request) {
        let { routeId, requestContext, dataStrategy, unstable_generateMiddlewareResponse: generateMiddlewareResponse } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        let url = new URL(request.url);
        let method = request.method;
        let location = createLocation("", createPath(url), null, "default");
        let matches = matchRoutes(dataRoutes, location, basename);
    ...
    async function loadRouteData(request, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch, filterMatchesToLoad, pendingActionResult) {
        ...
        if (isRouteRequest && !(routeMatch === null || routeMatch === void 0 ? void 0 : routeMatch.route.loader) && !(routeMatch === null || routeMatch === void 0 ? void 0 : routeMatch.route.lazy)) {
...
function getMatchesToLoad(request, scopedContext, mapRouteProperties2, manifest, history, state, matches, submission, location, lazyRoutePropertiesToSkip, initialHydration, isRevalidationRequired, cancelledFetcherLoads, fetchersQueuedForDeletion, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, hasPatchRoutesOnNavigation, pendingActionResult) {
    ...
    let baseShouldRevalidateArgs = {
        currentUrl,
        currentParams: ((_state_matches_ = state.matches[0]) === null || _state_matches_ === void 0 ? void 0 : _state_matches_.params) || {},
        nextUrl,
...
function patchRoutesImpl(routeId, children, routesToUse, manifest, mapRouteProperties2, allowElementMutations) {
    ...
    if (uniqueChildren.length > 0) {
        let newRoutes = convertRoutesToDataRoutes(uniqueChildren, mapRouteProperties2, [
            routeId || "_",
            "patch",
            String((childrenToPatch === null || childrenToPatch === void 0 ? void 0 : childrenToPatch.length) || "0")
        ], manifest);
...
function isSameRoute(newRoute, existingRoute) {
    ...
    return newRoute.children.every((aChild, i)=>{
        ...
        return (_existingRoute_children = existingRoute.children) === null || _existingRoute_children === void 0 ? void 0 : _existingRoute_children.some((bChild)=>isSameRoute(aChild, bChild));
    });
}
var lazyRoutePropertyCache = /* @__PURE__ */ new WeakMap();
var loadLazyRouteProperty = (param)=>{
    let { key, route, manifest, mapRouteProperties: mapRouteProperties2 } = param;
...
function loadLazyRoute(route, type, manifest, mapRouteProperties2, lazyRoutePropertiesToSkip) {
    ...
    lazyRoutePromise === null || lazyRoutePromise === void 0 ? void 0 : lazyRoutePromise.catch(()=>{});
    lazyHandlerPromise === null || lazyHandlerPromise === void 0 ? void 0 : lazyHandlerPromise.catch(()=>{});
    return {
        lazyRoutePromise,
        lazyHandlerPromise
    };
...
function loadLazyMiddlewareForMatches(matches, manifest, mapRouteProperties2) {
    let promises = matches.map((param)=>{
        let { route } = param;
...
function clientMiddlewareErrorHandler(error, routeId, matches, didCallHandler) {
    if (didCallHandler) {
        ...
        var _matches_find;
        let boundaryRouteId = findNearestBoundary(matches, ((_matches_find = matches.find((m)=>m.route.id === routeId || m.route.loader)) === null || _matches_find === void 0 ? void 0 : _matches_find.route.id) || routeId).route.id;
        return {
            [boundaryRouteId]: {
                type: "error",
                result: error
...
async function callServerRouteMiddleware(args, middlewares, handler, errorHandler) {
    let idx = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 0;
    let { request } = args;
    if (request.signal.aborted) {
...
async function callClientRouteMiddleware(args, middlewares, handler, errorHandler) {
    let handlerResult = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : {}, idx = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : 0;
    let { request } = args;
    if (request.signal.aborted) {
        if (request.signal.reason) {
            throw request.signal.reason;
...
function getDataStrategyMatch(mapRouteProperties2, manifest, request, match, lazyRoutePropertiesToSkip, scopedContext, shouldLoad) {
    let unstable_shouldRevalidateArgs = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : null;
...
function getTargetedDataStrategyMatches(mapRouteProperties2, manifest, request, matches, targetMatch, lazyRoutePropertiesToSkip, scopedContext) {
    let shouldRevalidateArgs = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : null;
...
async function callLoaderOrAction(param) {
    let { request, match, lazyHandlerPromise, lazyRoutePromise, handlerOverride, scopedContext } = param;
    let result;
    let onReject;
...
async function convertDataStrategyResultToDataResult(dataStrategyResult) {
        ...
        if (isDataWithResponseInit(result)) {
            ...
            if (result.data instanceof Error) {
                ...
                return {
                    type: "error" /* error */ ,
                    error: result.data,
                    statusCode: (_result_init2 = result.init) === null || _result_init2 === void 0 ? void 0 : _result_init2.status,
                    headers: ((_result_init3 = result.init) === null || _result_init3 === void 0 ? void 0 : _result_init3.headers) ? new Headers(result.init.headers) : void 0
                };
            }
            return {
                type: "error" /* error */ ,
                error: new ErrorResponseImpl(((_result_init = result.init) === null || _result_init === void 0 ? void 0 : _result_init.status) || 500, void 0, result.data),
                statusCode: isRouteErrorResponse(result) ? result.status : void 0,
                headers: ((_result_init1 = result.init) === null || _result_init1 === void 0 ? void 0 : _result_init1.headers) ? new Headers(result.init.headers) : void 0
            };
        }
        return {
            type: "error" /* error */ ,
    ...
    if (isDataWithResponseInit(result)) {
        ...
        return {
            type: "data" /* data */ ,
            data: result.data,
            statusCode: (_result_init4 = result.init) === null || _result_init4 === void 0 ? void 0 : _result_init4.status,
            headers: ((_result_init5 = result.init) === null || _result_init5 === void 0 ? void 0 : _result_init5.headers) ? new Headers(result.init.headers) : void 0
        };
    }
    return {
        type: "data" /* data */ ,
...
function processRouteLoaderData(matches, results, pendingActionResult) {
    let isStaticHandler = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false, skipLoaderErrorBubbling = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : false;
    let loaderData = {};
    let errors = null;
    let statusCode;
...
function processLoaderData(state, matches, results, pendingActionResult, revalidatingFetchers, fetcherResults) {
    ...
    revalidatingFetchers.filter((f)=>!f.matches || f.matches.some((m)=>m.shouldLoad)).forEach((rf)=>{
        ...
        if (isErrorResult(result)) {
            let boundaryMatch = findNearestBoundary(state.matches, match === null || match === void 0 ? void 0 : match.route.id);
...
function mergeLoaderData(loaderData, newLoaderData, matches, errors) {
    let mergedLoaderData = Object.entries(newLoaderData).filter((param)=>{
        let [, v] = param;
...
function getInternalRouterError(status) {
    let { pathname, routeId, method, type, message } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
function dataWithResponseInitToErrorResponse(data2) {
    var _data2_init, _data2_init1;
    var _data2_init_status, _data2_init_statusText;
    return new ErrorResponseImpl((_data2_init_status = (_data2_init = data2.init) === null || _data2_init === void 0 ? void 0 : _data2_init.status) !== null && _data2_init_status !== void 0 ? _data2_init_status : 500, (_data2_init_statusText = (_data2_init1 = data2.init) === null || _data2_init1 === void 0 ? void 0 : _data2_init1.statusText) !== null && _data2_init_statusText !== void 0 ? _data2_init_statusText : "Internal Server Error", data2.data);
}
...
;
function useHref(to) {
    let { relative } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
function _renderMatches(matches) {
    let parentMatches = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], dataRouterState = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, future = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : null;
    if (matches == null) {
        if (!dataRouterState) {
            return null;
        }
...
function useRouteError() {
    ...
    return (_state_errors = state.errors) === null || _state_errors === void 0 ? void 0 : _state_errors[routeId];
}
...
function RouterProvider(param) {
    ...
    let setState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "RouterProvider.useCallback[setState]": (newState, param)=>{
            let { deletedFetchers, flushSync, viewTransitionOpts } = param;
...
function Router(param) {
    let { basename: basenameProp = "/", children = null, location: locationProp, navigationType = "POP" /* Pop */ , navigator, static: staticProp = false } = param;
...
function WithComponentProps(param) {
    let { children } = param;
...
function WithHydrateFallbackProps(param) {
    let { children } = param;
...
function WithErrorBoundaryProps(param) {
    let { children } = param;
            ...
            case "object":
                {
                    ...
                    if (!pluginHandled) {
                        ...
                        if (isArray) {
                            ...
                            if (input2.size > 0) {
                                str[index2] = '["'.concat(TYPE_SET, '",').concat([
                                    ...input2
...
async function decode(readable, options) {
    const { plugins } = options !== null && options !== void 0 ? options : {};
...
function encode(input, options) {
    const { plugins, postPlugins, signal } = options !== null && options !== void 0 ? options : {};
    const encoder = {
        deferred: {},
        index: 0,
...
function getSingleFetchDataStrategyImpl(getRouter, getRouteInfo, fetchAndDecode, ssr, basename) {
    let shouldAllowOptOut = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : ()=>true;
    return async (args)=>{
...
async function singleFetchLoaderNavigationStrategy(args, router, getRouteInfo, fetchAndDecode, ssr, basename) {
    let shouldAllowOptOut = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : ()=>true;
            ...
            for (let match of matches){
                if (match.route.id in fetchedData.routes) {
                    ...
                    if ("error" in routeResult) {
                        var _results_match_route_id;
                        middlewareError = routeResult.error;
                        if (((_results_match_route_id = results[match.route.id]) === null || _results_match_route_id === void 0 ? void 0 : _results_match_route_id.result) == null) {
...
async function fetchAndDecodeViaTurboStream(args, basename, targetRoutes) {
    ...
    try {
        ...
        if (request.method === "GET") {
            ...
            let typed = decoded.value;
            let routeId = targetRoutes === null || targetRoutes === void 0 ? void 0 : targetRoutes[0];
...
function getKeyedLinksForMatches(matches, routeModules, manifest) {
    let descriptors = matches.map((match)=>{
        ...
        return [
            ...
            (module === null || module === void 0 ? void 0 : (_module_links = module.links) === null || _module_links === void 0 ? void 0 : _module_links.call(module)) || []
        ];
    }).flat(2);
...
function getNewMatchesForLinks(page, nextMatches, currentMatches, manifest, location, mode) {
    ...
    let matchPathChanged = (match, index)=>{
        ...
        currentMatches[index].pathname !== match.pathname || ((_currentMatches_index_route_path = currentMatches[index].route.path) === null || _currentMatches_index_route_path === void 0 ? void 0 : _currentMatches_index_route_path.endsWith("*")) && currentMatches[index].params["*"] !== match.params["*"]);
    };
    if (mode === "assets") {
...
function getModuleLinkHrefs(matches, manifest) {
    let { includeHydrateFallback } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
...
function createServerRoutes(manifest, routeModules, future, isSpaMode) {
    let parentId = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : "", routesByParentId = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : groupRoutesByParentId(manifest), spaModeLazyPromise = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : Promise.resolve({
        Component: ()=>null
    });
...
function preventInvalidServerHandlerCall(type, route) {
    if (type === "loader" && !route.hasLoader || type === "action" && !route.hasAction) {
        ...
        let msg = "You are trying to call ".concat(fn, " on a route that does not have a server ").concat(type, ' (routeId: "').concat(route.id, '")');
        console.error(msg);
...
function noActionDefinedError(type, routeId) {
    ...
    let msg = 'Route "'.concat(routeId, '" does not have ').concat(article, " ").concat(type, ", but you are trying to submit to it. To fix this, please add ").concat(article, " `").concat(type, "` function to the route");
    console.error(msg);
    throw new ErrorResponseImpl(405, "Method Not Allowed", new Error(msg), true);
}
function createClientRoutes(manifest, routeModulesCache, initialState, ssr, isSpaMode) {
    let parentId = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : "", routesByParentId = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : groupRoutesByParentId(manifest), needsRevalidation = arguments.length > 7 ? arguments[7] : void 0;
    return (routesByParentId[parentId] || []).map((route)=>{
        ...
        if (routeModule) {
            var _initialState_loaderData, _initialState_errors, _routeModule_clientLoader;
            ...
            let initialData = hasInitialData ? initialState === null || initialState === void 0 ? void 0 : (_initialState_loaderData = initialState.loaderData) === null || _initialState_loaderData === void 0 ? void 0 : _initialState_loaderData[route.id] : void 0;
            let hasInitialError = initialState && initialState.errors && route.id in initialState.errors;
            let initialError = hasInitialError ? initialState === null || initialState === void 0 ? void 0 : (_initialState_errors = initialState.errors) === null || _initialState_errors === void 0 ? void 0 : _initialState_errors[route.id] : void 0;
            let isHydrationRequest = needsRevalidation == null && (((_routeModule_clientLoader = routeModule.clientLoader) === null || _routeModule_clientLoader === void 0 ? void 0 : _routeModule_clientLoader.hydrate) === true || !route.hasLoader);
...
function useFogOFWarDiscovery(router, manifest, routeModules, ssr, routeDiscovery, isSpaMode) {
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "useFogOFWarDiscovery.useEffect": ()=>{
            ...
            _window_navigator_connection, _window_navigator;
            if (!isFogOfWarEnabled(routeDiscovery, ssr) || ((_window_navigator = window.navigator) === null || _window_navigator === void 0 ? void 0 : (_window_navigator_connection = _window_navigator.connection) === null || _window_navigator_connection === void 0 ? void 0 : _window_navigator_connection.saveData) === true) {
                return;
            }
...
function Links(param) {
    ...
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], null, typeof criticalCss === "string" ? /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"]("style", {
        ...
        nonce
    }) : null, keyedLinks.map((param)=>{
        let { key, link } = param;
        return isPageLinkDescriptor(link) ? /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](PrefetchPageLinks, {
            key,
            nonce,
            ...link
...
function PrefetchPageLinksImpl(param) {
        ...
        "PrefetchPageLinksImpl.useMemo[dataHrefs]": ()=>{
            ...
            nextMatches.forEach({
                "PrefetchPageLinksImpl.useMemo[dataHrefs]": (m)=>{
                    ...
                    }["PrefetchPageLinksImpl.useMemo[dataHrefs]"]) && m.route.id in loaderData && ((_routeModules_m_route_id = routeModules[m.route.id]) === null || _routeModules_m_route_id === void 0 ? void 0 : _routeModules_m_route_id.shouldRevalidate)) {
                        foundOptOutRoute = true;
    ...
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], null, dataHrefs.map((href)=>/* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"]("link", {
        ...
        let { key, link } = param;
        return(// these don't spread `linkProps` because they are full link descriptors
...
function Meta() {
    ...
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], null, meta.flat().map((metaProps)=>{
        ...
        if ("charset" in metaProps) {
            ...
            (_metaProps_charSet = metaProps.charSet) !== null && _metaProps_charSet !== void 0 ? _metaProps_charSet : metaProps.charSet = metaProps.charset;
...
function Scripts(scriptProps) {
    ...
    let initialScripts = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "Scripts.useMemo[initialScripts]": ()=>{
            ...
            let contextScript = staticContext ? "window.__reactRouterContext = ".concat(serverHandoffString, ";").concat(streamScript) : " ";
            let routeModulesScript = !isStatic ? " " : "".concat(((_manifest_hmr = manifest.hmr) === null || _manifest_hmr === void 0 ? void 0 : _manifest_hmr.runtime) ? "import ".concat(JSON.stringify(manifest.hmr.runtime), ";") : "").concat(!enableFogOfWar ? "import ".concat(JSON.stringify(manifest.url)) : "", ";\n").concat(matches.map({
                "Scripts.useMemo[initialScripts]": (match, routeIndex)=>{
                    ...
                    let chunkImportsSnippet = chunks.map({
                        "Scripts.useMemo[initialScripts].chunkImportsSnippet": (chunk)=>"import * as ".concat(chunk.varName, ' from "').concat(chunk.module, '";')
                    }["Scripts.useMemo[initialScripts].chunkImportsSnippet"]).join("\n");
                    let mergedChunksSnippet = "const ".concat(routeVarName, " = {").concat(chunks.map({
                        "Scripts.useMemo[initialScripts].mergedChunksSnippet": (chunk)=>"...".concat(chunk.varName)
                    }["Scripts.useMemo[initialScripts].mergedChunksSnippet"]).join(","), "};");
                    return [
                        chunkImportsSnippet,
                        mergedChunksSnippet
                    ].join("\n");
            ...
            "window.__reactRouterManifest = ".concat(JSON.stringify(getPartialManifest(manifest, router), null, 2), ";") : "", "\n  window.__reactRouterRouteModules = {").concat(matches.map({
                "Scripts.useMemo[initialScripts]": (match, index)=>"".concat(JSON.stringify(match.route.id), ":route").concat(index)
...
function BoundaryShell(param) {
    ...
    if (((_routeModules_root = routeModules.root) === null || _routeModules_root === void 0 ? void 0 : _routeModules_root.Layout) && !isOutsideRemixApp) {
        return children;
    }
...
try {
    if (isBrowser) {
        window.__reactRouterVersion = "7.8.0";
    }
} catch (e) {}
...
function parseHydrationData() {
    var _window;
    let state = (_window = window) === null || _window === void 0 ? void 0 : _window.__staticRouterHydrationData;
...
var Link = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"](function LinkWithRef(param, forwardedRef) {
    let { onClick, discover = "render", prefetch = "none", relative, reloadDocument, replace: replace2, state, target, to, preventScrollReset, viewTransition, ...rest } = param;
...
var NavLink = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"](function NavLinkWithRef(param, ref) {
    let { "aria-current": ariaCurrentProp = "page", caseSensitive = false, className: classNameProp = "", end = false, style: styleProp, to, viewTransition, children, ...rest } = param;
...
var Form = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"]((param, forwardedRef)=>{
    let { discover = "render", fetcherKey, navigate, reloadDocument, replace: replace2, state, method = defaultMethod, action, onSubmit, relative, preventScrollReset, viewTransition, ...props } = param;
...
function useLinkClickHandler(to) {
    let { target, replace: replaceProp, state, preventScrollReset, relative, viewTransition } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    let navigate = useNavigate();
    let location = useLocation();
    let path = useResolvedPath(to, {
        relative
...
function useFetcher() {
    ...
    let route = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"](RouteContext);
    let routeId = (_route_matches_ = route.matches[route.matches.length - 1]) === null || _route_matches_ === void 0 ? void 0 : _route_matches_.route.id;
...
function useScrollRestoration() {
    let { getKey, storageKey } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    ...
    if (typeof document !== "undefined") {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"]({
            "useScrollRestoration.useLayoutEffect": ()=>{
                let disableScrollRestoration = router === null || router === void 0 ? void 0 : router.enableScrollRestoration(savedScrollPositions, {
...
function createStaticRouter(routes, context) {
    ...
    let msg = (method)=>"You cannot use router.".concat(method, "() on the server because it is a stateless environment");
    return {
        get basename () {
...
//# sourceMappingURL=node_modules_react-router_dist_development_chunk-ZYFC6VSF_mjs_9a89cc92._.js.map